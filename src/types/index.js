...
export const map2Select = map => {
  const arr = [];
  for (const key in map) {
    if (Object.hasOwnProperty.call(map, key)) {
      const element = map[key];
      arr.push({ label: element, value: key });
    }
  }
  return arr;
};
...
export const provinceCity = [
  {
    label: "北京市",
    value: "110000",
    children: [{ label: "市辖区", value: "110100" }]
  },
  {
    label: "天津市",
    value: "120000",
    children: [{ label: "市辖区", value: "120100" }]
  },
  {
    label: "河北省",
    value: "130000",
  ...
  },
  {
    label: "上海市",
    value: "310000",
    children: [{ label: "市辖区", value: "310100" }]
  },
  {
    label: "江苏省",
    value: "320000",
  ...
  },
  {
    ...
    value: "810000",
    children: [
      { label: "中西區", value: "810001" },
      { label: "灣仔區", value: "810002" },
      { label: "東區", value: "810003" },
      { label: "南區", value: "810004" },
      { label: "油尖旺區", value: "810005" },
      { label: "深水埗區", value: "810006" },
      { label: "九龍城區", value: "810007" },
      { label: "黃大仙區", value: "810008" },
      { label: "觀塘區", value: "810009" },
      { label: "荃灣區", value: "810010" },
      { label: "屯門區", value: "810011" },
      { label: "元朗區", value: "810012" },
      { label: "北區", value: "810013" },
      { label: "大埔區", value: "810014" },
      { label: "西貢區", value: "810015" },
      { label: "沙田區", value: "810016" },
      { label: "葵青區", value: "810017" },
      { label: "離島區", value: "810018" }
    ]
  },
  {
    label: "澳门特别行政区",
    value: "820000",
    children: [
      { label: "花地瑪堂區", value: "820001" },
      { label: "花王堂區", value: "820002" },
      { label: "望德堂區", value: "820003" },
      { label: "大堂區", value: "820004" },
      { label: "風順堂區", value: "820005" },
      { label: "嘉模堂區", value: "820006" },
      { label: "路氹填海區", value: "820007" },
      { label: "聖方濟各堂區", value: "820008" }
    ]
  }
];
...
export const provinceCityArea = [
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: "小榄镇", value: "442000100" },
          { label: "黄圃镇", value: "442000101" },
          { label: "民众镇", value: "442000102" },
          { label: "东凤镇", value: "442000103" },
          { label: "东升镇", value: "442000104" },
    ...
    children: [
      {
        ...
        value: "710100",
        children: [
          { label: "内湖区", value: "710101" },
          { label: "南港区", value: "710102" },
          { label: "中正区", value: "710103" },
          { label: "松山区", value: "710104" },
          { label: "信义区", value: "710105" },
          { label: "大安区", value: "710106" },
          { label: "中山区", value: "710107" },
          { label: "文山区", value: "710108" },
          { label: "大同区", value: "710109" },
          { label: "万华区", value: "710110" },
          { label: "士林区", value: "710111" },
          { label: "北投区", value: "710112" }
        ]
      },
      {
        label: "高雄市",
      ...
      },
      {
        ...
        value: "710300",
        children: [
          { label: "仁爱区", value: "710301" },
          { label: "信义区", value: "710302" },
          { label: "中正区", value: "710303" },
          { label: "暖暖区", value: "710304" },
          { label: "安乐区", value: "710305" },
          { label: "七堵区", value: "710307" }
        ]
      },
      {
        label: "台中市",
        value: "710400",
        children: [
          { label: "中区", value: "710301" },
          { label: "东区", value: "710302" },
          { label: "南区", value: "710303" },
          { label: "西区", value: "710304" },
          { label: "北区", value: "710305" },
          { label: "北屯区", value: "710306" },
          { label: "西屯区", value: "710307" },
          { label: "南屯区", value: "710308" }
        ]
      },
      {
        label: "台南市",
        value: "710500",
        children: [
          { label: "中西区", value: "710501" },
          { label: "东区", value: "710502" },
          { label: "南区", value: "710503" },
          { label: "北区", value: "710504" },
          { label: "安平区", value: "710505" },
          { label: "安南区", value: "710506" }
        ]
      },
      {
        label: "新竹市",
        value: "710600",
        children: [
          { label: "东区", value: "710601" },
          { label: "北区", value: "710602" },
          { label: "香山区", value: "710603" }
        ]
      },
      {
        label: "嘉义市",
        value: "710700",
        children: [
          { label: "东区", value: "710701" },
          { label: "西区", value: "710702" }
        ]
      }
    ]
  },
  ...
  },
  {
    ...
    value: "810000",
    children: [
      { label: "中西區", value: "810001", children: [] },
      { label: "灣仔區", value: "810002", children: [] },
      { label: "東區", value: "810003", children: [] },
      { label: "南區", value: "810004", children: [] },
      { label: "油尖旺區", value: "810005", children: [] },
      { label: "深水埗區", value: "810006", children: [] },
      { label: "九龍城區", value: "810007", children: [] },
      { label: "黃大仙區", value: "810008", children: [] },
      { label: "觀塘區", value: "810009", children: [] },
      { label: "荃灣區", value: "810010", children: [] },
      { label: "屯門區", value: "810011", children: [] },
      { label: "元朗區", value: "810012", children: [] },
      { label: "北區", value: "810013", children: [] },
      { label: "大埔區", value: "810014", children: [] },
      { label: "西貢區", value: "810015", children: [] },
      { label: "沙田區", value: "810016", children: [] },
      { label: "葵青區", value: "810017", children: [] },
      { label: "離島區", value: "810018", children: [] }
    ]
  },
  {
    children: [
  ...
  },
  {
    ...
    value: "820000",
    children: [
      { label: "花地瑪堂區", value: "820001", children: [] },
      { label: "花王堂區", value: "820002", children: [] },
      { label: "望德堂區", value: "820003", children: [] },
      { label: "大堂區", value: "820004", children: [] },
      { label: "風順堂區", value: "820005", children: [] },
      { label: "嘉模堂區", value: "820006", children: [] },
      { label: "路氹填海區", value: "820007", children: [] },
      { label: "聖方濟各堂區", value: "820008", children: [] }
    ]
  },
  {
    children: [
...
export const provinceCityName = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "省直辖县级行政区划", value: "省直辖县级行政区划" }
    ]
  },
  {
    label: "湖北省",
