<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="iconList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="功能图标" align="center" prop="icon" />
      <el-table-column label="跳转地址" align="center" prop="redirect" />
      <el-table-column label="功能排序" align="center" prop="sort" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="功能图标" prop="icon">
          <el-input v-model="form.icon" placeholder="请输入功能图标" />
        </el-form-item>
        <el-form-item label="跳转地址" prop="redirect">
          <el-input v-model="form.redirect" placeholder="请输入跳转地址" />
        </el-form-item>
        <el-form-item label="功能排序" prop="sort">
          <el-input v-model="form.sort" placeholder="请输入功能排序" />
        </el-form-item>
...
<script>
import { listIcon, getIcon, delIcon, addIcon, updateIcon, exportIcon } from "@/api/spc/icon";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除icon功能编号为"' + ids + '"的数据项?', "警告", {
    ...
    handleExport() {
      ...
      this.$confirm('是否确认导出所有icon功能数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
