<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="开始时间" prop="fromTime">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['spc:homebanner:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['spc:homebanner:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['spc:homebanner:export']"
        >导出</el-button>
      </el-col>
      <right-toolbar :showSearch.sync="showSearch" @queryTable="getList"></right-toolbar>
    </el-row>

    <el-table v-loading="loading" :data="homebannerList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="主键" align="center" prop="id" />
      <el-table-column label="图片地址" align="center" prop="imgUrl" />
      <el-table-column label="排序值" align="center" prop="order" />
      <el-table-column label="跳转地址" align="center" prop="redirect" />
      <el-table-column label="当前状态" align="center" prop="status" />
      <el-table-column label="开始时间" align="center" prop="fromTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.fromTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
      <el-table-column label="结束时间" align="center" prop="toTime" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.toTime, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="排序值" prop="order">
          <el-input v-model="form.order" placeholder="请输入排序值" />
        </el-form-item>
        <el-form-item label="跳转地址" prop="redirect">
...
<script>
import { listHomebanner, getHomebanner, delHomebanner, addHomebanner, updateHomebanner, exportHomebanner } from "@/api/spc/homebanner";
